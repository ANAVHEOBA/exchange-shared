    ...
    modules::{
        admin::{
            controller::{
                ...
                __path_global_search, __path_login as __path_admin_login, __path_ops_health,
                __path_overview as __path_admin_overview, __path_webhook_monitor,
            },
            schema::{
                ...
                AdminUserResponse, OpsCreateNoteRequest, OpsDashboardResponse, OpsFinanceDailyRow,
                OpsFinanceProviderRow, OpsFinanceQuery, OpsFinanceResponse, OpsFinanceTotals,
                OpsHealthResponse, OpsNoteResponse, OpsProviderHealthRow, OpsRiskFlag,
                OpsSearchGiftCardResult, OpsSearchQuery, OpsSearchResponse, OpsSearchSupportResult,
                OpsSearchSwapResult, OpsWebhookDeliveryRow, OpsWebhookMonitorResponse,
                OpsWorkerHealth,
            },
        },
        auth::{

...
impl SwapService {
    ...
    fn build_live_status_response(
        ...
        SwapStatusResponse {
            ...
            network_from: swap.from_network.clone(),
            to: swap.to_currency.clone(),
            network_to: swap.to_network.clone(),
            amount: swap.amount,
            ...
            refund_address: swap.refund_address.clone(),
            refund_extra_id: swap.refund_extra_id.clone(),
            rate: swap.rate,
    ...
    fn build_cached_status_response(swap: SwapStatusRecord) -> SwapStatusResponse {
        ...
        SwapStatusResponse {
            ...
            network_from: swap.from_network,
            to: swap.to_currency,
            network_to: swap.to_network,
            amount: swap.amount,

...
impl TokenGasEstimator {
    ...
    pub fn estimate_gas_cost(token: &Token, gas_price: U256, include_approval: bool) -> U256 {
...
mod tests {
    ...
    fn test_gas_cost_usd() {
        ...
        let cost_usd =
            TokenGasEstimator::estimate_gas_cost_usd(&token, gas_price_gwei, eth_price_usd, false);
